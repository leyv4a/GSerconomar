...
function Producto() {
  ...
  const [productoActual, setProductoActual] = useState(Harina);
  ...
  return (
    ...
    <section id='productos' className='pt-5 container' style={{width: '100vw', height: '100vh'}}>
     <div className=" d-flex flex-column align-items-center gap-4" style={{width: '100%', height: '30%'}}>
      <h2 className='fs-1'><span className='border-bottom border-primary border-4 '>{t('productos.presentacion')}&nbsp; &nbsp;</span></h2>
